                    ...
                    <div className="w-1/2 overflow-x-auto">
                        <table className="table-auto border-collapse border border-gray-300 text-sm max-w-4xl mx-auto">
                            ...
                            <tbody>
                                ...
                                {/* แถวที่ 2: เงื่อนไข B */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">9</td>
                                ...
                                {/* แถวที่ 3: เงื่อนไข C */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">5</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                ...
                                {/* แถวที่ 5: เงื่อนไข E */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">36</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                ...
                                <tr>
                                    ...
                                    <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">34</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">ชั่วโมง</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                        creditG !== 34 ? 'text-red-500' : 'text-green-500'
                                    }`}>
                                        {creditG}
                                    </th>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">ชั่วโมง</td>
