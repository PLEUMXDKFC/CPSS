        ...
        const fetchSubjectData = async () => {
            try {
                ...
                const totalA = filteredData.reduce((total, subject) => {
                    if (
                        subject.subject_category === "1. หมวดวิชาสรรถนะแกนกลาง" &&
            ...
            <div className="flex-1 ml-72 p-6 overflow-auto">
                ...
                <div className="flex flex-row mt-6">
                    ...
                    <div className="mt-6 text-lg text-gray-700 w-1/2">
                        ...
                        <p className="mt-4"><strong>2. หมวดวิชาสมรรถนะวิชาชีพ (ไม่น้อยกว่า)</strong></p>
                        ...
                        <p className="mt-4"><strong>4. กิจกรรมเสริมหลักสูตร</strong></p>
                    </div>
                    ...
                    <div className="w-1/2 overflow-x-auto">
                        <table className="table-auto border-collapse border border-gray-300 text-sm max-w-4xl mx-auto">
                            ...
                            <tbody>
                                ...
                                {/* แถวที่ 2: เงื่อนไข B */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">6</td>
                                ...
                                {/* แถวที่ 3: เงื่อนไข C */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">3</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                ...
                                {/* แถวที่ 4: เงื่อนไข D */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">34</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                ...
                                {/* แถวที่ 5: เงื่อนไข E */}
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">26</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                ...
                                <tr>
                                    ...
                                    <tr>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">2</td>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">ชั่วโมงต่อสัปดาห์</td>
                                    <th className={`border border-gray-300 px-4 py-2 text-center ${
                                        creditG !== 2 ? 'text-red-500' : 'text-green-500'
                                    }`}>
                                        {creditG}
                                    </th>
                                    <td className="border border-gray-300 px-4 py-2 text-center text-black">ชั่วโมงต่อสัปดาห์</td>
