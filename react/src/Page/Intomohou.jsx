                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {plans.map(plan => (
                        <div key={plan.planid} 
                            ...
                            onClick={() => navigate(`/Redirectmohou/${plan.planid}?course=${encodeURIComponent(plan.course)}&year=${plan.year}&student_id=${plan.student_id}&group=${plan.group}`, { state: plan })}>
